...
from . import (lang_AM, lang_AR, lang_AZ, lang_BE, lang_BN, lang_CA, lang_CE,
               ...
               lang_FR_BE, lang_FR_CH, lang_FR_DZ, lang_GU, lang_HE, lang_HI,
               lang_HU, lang_ID, lang_IS, lang_IT, lang_JA, lang_KN, lang_KO,
               lang_KZ, lang_LT, lang_LV, lang_ML, lang_MR, lang_NL, lang_NO,
               lang_OR, lang_PA, lang_PL, lang_PT, lang_PT_BR, lang_RO,
               lang_RU, lang_SK, lang_SL, lang_SR, lang_SV, lang_TA, lang_TE,
